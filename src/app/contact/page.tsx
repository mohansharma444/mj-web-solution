        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
              We look forward to partnering with you. Use the quick links below to trigger direct calls, chats, or profile traces.
            </p>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="border border-slate-200/60 rounded-2xl p-5 bg-white flex items-center gap-4 hover:border-blue-200 transition-colors">
                <div className="w-11 h-11 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center text-xl font-bold flex-shrink-0">
                  📞
                </div>
                <div className="flex-grow">
                  <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wide">Call Support</span>
                  <a href="tel:+916378695789" className="text-sm sm:text-base font-bold text-slate-800 hover:text-blue-600 transition-colors">
                    +91 6378695789
                  </a>
                </div>
                <a
              ...
              <div className="border border-slate-200/60 rounded-2xl p-5 bg-white flex items-center gap-4 hover:border-emerald-200 transition-colors">
                <div className="w-11 h-11 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center text-xl font-bold flex-shrink-0">
                  💬
                </div>
                <div className="flex-grow">
                  <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wide">WhatsApp Support</span>
                  <a href="https://wa.me/916378695789" target="_blank" rel="noopener noreferrer" className="text-sm sm:text-base font-bold text-slate-800 hover:text-emerald-600 transition-colors">
                    +91 6378695789
                  </a>
                </div>
                <a
                  ...
                  className="bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold px-4 py-2 rounded-lg transition-colors whitespace-nowrap"
                >
                  Chat Now
                </a>
              </div>
              ...
              <div className="border border-slate-200/60 rounded-2xl p-5 bg-white flex items-center gap-4 hover:border-blue-200 transition-colors">
                ...
                <div className="flex-grow">
                  ...
                  <a href="mailto:ms110vms@gmail.com" className="text-sm sm:text-base font-bold text-slate-800 hover:text-blue-600 transition-colors">
                    ms110vms@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="border border-slate-200/60 rounded-2xl p-5 bg-white flex items-center gap-4 hover:border-pink-200 transition-colors">
                <div className="w-11 h-11 bg-pink-50 text-pink-600 rounded-xl flex items-center justify-center text-xl font-bold flex-shrink-0">
                  📸
                </div>
                <div className="flex-grow">
                  <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wide">Instagram Profile</span>
                  <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-sm sm:text-base font-bold text-slate-800 hover:text-pink-655 transition-colors">
                    @mjwebsolution
                  </a>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 text-white text-xs font-bold px-4 py-2 rounded-lg transition-colors whitespace-nowrap"
                >
                  Follow
                </a>
              </div>
